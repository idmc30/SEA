<?php $c=1; ?>  
  <?php  foreach ($litems as $items): ?>
        <tr id="#">
          ...
          <a href="index.php?page=evento&action=item&key=<?php echo  base64_encode($items->evento_id) ?>&eventopadre=<?php 
                                                                                                                        //   echo  base64_encode($id_evento_pertenece_padre) 
                                                                                                                          if ($id_evento_pertenece_padre) {
                                                                                                                             echo $id_evento_pertenece_padre;
                                                                                                                          } else  {
                                                                                                                              if($id_evento_pertenece){
                                                                                                                                echo  $id_evento_pertenece; 
                                                                                                                              }
                                                                                                                          }
                                                                                                                       ?>">
